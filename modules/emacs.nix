...
(defvar base16-eva-evil-theme-colors
  '(:base00 "#2a3b4d"
    :base01 "#3d566f"
    :base02 "#4b6988"
    :base03 "#55799c"
...
;; Define the theme
(deftheme base16-eva-evil)

;; Add all the faces to the theme
(base16-theme-define 'base16-eva-evil base16-eva-evil-theme-colors)

;; Mark the theme as provided
(provide-theme 'base16-eva-evil)

(provide 'base16-eva-evil-theme)
    ''; 
  }];
}
